...
var require_log = __commonJS({
  "node_modules/tailwindcss/lib/util/log.js"(exports) {
    ...
    function log(chalk, messages, key) {
      ...
      console.warn("");
      messages.forEach(
        (message) => console.warn(chalk, "-", message)
      );
    }
    function dim(input) {
  ...
  "node_modules/daisyui/src/index.js"(exports, module) {
    ...
    var mainFunction = ({ addBase, addComponents, config }) => {
      ...
      if (logs) {
        ...
        console.log(
          "\x1B[35m%s\x1B[0m",
          "\u{1F33C} daisyUI " + daisyuiInfo.version,
      ...
      if (logs) {
        ...
        if (themeInjectorHsl.themeOrder.length > 0) {
          console.log(
            " \u2570\u2500",
            "\x1B[32m\u2714\uFE0E\x1B[0m",
            `\x1B[2m[ \x1B[0m${themeInjectorHsl.themeOrder.length}\x1B[2m ]\x1B[0m ${themeInjectorHsl.themeOrder.length > 1 ? "themes are" : "theme is"} enabled. You can add more themes or make your own theme:
...
// dep:daisyui
var daisyui_default = require_src();
export {
